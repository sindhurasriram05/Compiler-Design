...
data = open('/Users/deeksha/Desktop/MyPythonCompiler/lexer/for.py','r')
lex.input(data.read())
data.close()


op = open('/Users/deeksha/Desktop/MyPythonCompiler/lexer/code','w')

st = open('/Users/deeksha/Desktop/MyPythonCompiler/lexer/symbol_table','w')
